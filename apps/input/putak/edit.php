...
$data = query("SELECT * FROM tb_putak WHERE id = $id")[0];
...
if (isset($_POST['edit_senal'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($simpan) {
            ...
            header("Location:../../../index.php?page=inputak&edit=berhasil");
        } else {
            mysqli_query($conn, "ROLLBACK");
            header("Location:../../../index.php?page=inputak&add=gagal");
        }
    }
}
?>
...
<!-- Formulir Edit Data -->
<form action="apps/input/putak/edit.php" method="post" enctype="multipart/form-data">
