...
$putak = query("SELECT * FROM tb_putak");
...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Input Data Senal putak</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="index.php?page=dashboard">Home</a></li>
                    <li class="breadcrumb-item active">Input Data Senal putak</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
                                ...
                                <?php foreach ($putak as $row) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-danger btn-hapus" href="apps/input/putak/hapus.php?id=<?= $row["id"] ?>"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    <?php $i++ ?>
                                <?php endforeach; ?>
...
<script>
    ...
    $('#tombol_tambah').on('click', function() {
        $.ajax({
            url: 'apps/input/putak/tambah.php',
            method: 'post',
            success: function(data) {
                $('#tampil_data').html(data);
                document.getElementById("judul").innerHTML = 'Tambah Data Progres Senal putak';
            }
        });
        // Membuka modal
        $('#modal').modal('show');
