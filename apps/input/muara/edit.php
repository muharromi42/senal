...
$data = query("SELECT * FROM tb_muara WHERE id = $id")[0];
...
if (isset($_POST['edit_senal'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($simpan) {
            ...
            header("Location:../../../index.php?page=inmuara&edit=berhasil");
        } else {
...
<!-- Formulir Edit Data -->
<form action="apps/input/muara/edit.php" method="post" enctype="multipart/form-data">
